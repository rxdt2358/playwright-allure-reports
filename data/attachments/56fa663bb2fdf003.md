    ...
    - generic [ref=e43]:
      ...
      - generic [ref=e54]:
        - generic [ref=e55]:
          - text: Name
          - superscript [ref=e56]: "*"
        - textbox "Name *" [ref=e57]: user_1778681580786
      - generic [ref=e58]:
        - generic [ref=e59]:
          - text: Email
          - superscript [ref=e60]: "*"
        - textbox "Email *" [disabled] [ref=e61]: user_1778681580786@mail.com
      - generic [ref=e62]:
        - generic [ref=e63]:
          - text: Password
          - superscript [ref=e64]: "*"
        - textbox "Password *" [active] [ref=e65]: user_1778681580786_123456
      - generic [ref=e66]:
...
```ts
  ...
  17 | 
> 18 |         await this.page.selectOption(signupLocators.form.days, { value: String(data.day) });
     |                         ^ Error: page.selectOption: Test timeout of 30000ms exceeded.
  19 |         await this.page.selectOption(signupLocators.form.months, { value: String(data.month) });
  20 |         await this.page.selectOption(signupLocators.form.years, { value: String(data.year) });
  21 | 
