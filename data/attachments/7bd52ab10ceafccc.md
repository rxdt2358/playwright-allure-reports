    ...
    - generic [ref=e43]:
      ...
      - generic [ref=e54]:
        - generic [ref=e55]:
          - text: Name
          - superscript [ref=e56]: "*"
        - textbox "Name *" [ref=e57]: user_1778680584919
      - generic [ref=e58]:
        - generic [ref=e59]:
          - text: Email
          - superscript [ref=e60]: "*"
        - textbox "Email *" [disabled] [ref=e61]: user_1778680584919@mail.com
      - generic [ref=e62]:
        - generic [ref=e63]:
          - text: Password
          - superscript [ref=e64]: "*"
        - textbox "Password *" [active] [ref=e65]: user_1778680584919_123456
      - generic [ref=e66]:
...
```ts
  ...
  16 | 
> 17 |         await this.page.locator(signupLocators.form.days).fill(data.day);
     |                                                           ^ Error: locator.fill: Error: Element is not an <input>, <textarea> or [contenteditable] element
